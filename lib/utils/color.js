...
export const hStopValueFromRange = (stop, range) =>
  stopValueFromCurve(stop, range.curves.h)
export const sStopValueFromRange = (stop, range) =>
  stopValueFromCurve(stop, range.curves.s)
export const lStopValueFromRange = (stop, range) =>
  stopValueFromCurve(stop, range.curves.l)
export const hslAtStopFromRange  = (stop, range) =>
  setHex({
